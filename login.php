...
<html lang="en">
  <head>
    ...
    <title>Login | Classroom Facilities</title>
    <!-- plugins:css -->
              ...
              <div class="auto-form-wrapper">
                <form action="login_checker.php" method="post">
                  ...
                  <div class="text-block text-center my-3">
                    ...
                    <a href="sign_up.php" class="text-black text-small">Create new account</a>
                  </div>
                </form>
              </div>
              <br><p class="footer-text text-center">copyright © Tawhidur Noor. All rights reserved.</p>
            </div>
          </div>
        </div>
