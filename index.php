<?php
      ...
      $sql = "SELECT f_name,l_name,email FROM users WHERE diu_id='$temp_id'";
...
<div class="container-fluid page-body-wrapper">
  ...
  <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Submit Yor Problem</h4>
                    <form class="forms-sample" action="continue_submiting.php" method="post">
                      <div class="form-group">
                        <label for="exampleTextarea1">Issue</label>
                        <textarea class="form-control" name="text" rows="2" placeholder="Enter Your Problem here within 255 words." maxlength="255"></textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail2">Stuff</label><br>
